...
// created an interface to take input from the user
...
// It should send the email using the sendMail method of the transporter object. If the email is sent successfully, it should displays a success message along with the recipient's email address, otherwise, it displays the error message. Lastly, it closes the readline interface.
